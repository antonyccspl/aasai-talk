...
-- The migration history in the hosted project includes the wallet functions,
-- but its REST schema cache did not expose them to the mobile client. Reapply
-- the current contracts and force PostgREST to reload its schema.
